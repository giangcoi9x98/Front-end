...
export default class index extends Component {
    render() {
        return (
            <Box style={{ height:'100%',display:'flex',flexDirection:'column',width:200}}>
                <Box p={4} style={{alignItems:'center',justifyContent:'center',display:'flex',flexDirection:'column'}}>
                    <Avatar src='/static/images/avatars/avatar.png' style={{width:64,height:64,cursor:'pointer'}}>

                    </Avatar>
                    <Typography variant='h5' color='textPrimary'>Giang Tran</Typography>
                    <Typography  color='textSecondary'>CNTT2-K58</Typography>
                </Box>
                <Divider></Divider>
                <Box p={3}>
                    <List>
                        <Button style={{ width: '100%', textTransform: 'none' ,justifyContent:'left',padding:'10px 8px',color:'GrayText' }} 
                            href='/'
                        >
